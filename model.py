...
if __name__ == "__main__":
    ...
    df_1_cont = pd.read_csv(f'{path2}/anp_thesis_project/df_1.csv', delimiter=',')
    ...
    df_2_cont = pd.read_csv(f'{path2}/anp_thesis_project/df_2.csv', delimiter=',')
    ...
    df_3_cont = pd.read_csv(f'{path2}/anp_thesis_project/df_3.csv', delimiter=',')

    df_4 = post_processing_1(df_3_cont)


    df_4_c = df_4.copy()
    df_4_c.to_csv('df_4.csv', index=False)
