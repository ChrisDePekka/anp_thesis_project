...
if __name__ == "__main__":
    ...
    if a == 1:
        ...
        df_0.to_csv(f'{lm_model}_exp_1_df_0.csv', index=False)
        ...
        df_1.to_csv(f'{lm_model}_exp_1_df_1.csv', index=False)
        ...
        df_2.to_csv(f'{lm_model}_exp_1_df_2.csv', index=False)
