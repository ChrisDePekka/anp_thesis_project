...
if __name__ == "__main__":
    ...
    if a == 1:
        ...
        df_0.to_csv(f'{lm_model}_exp_1_df_0_n.csv', index=False)
        ...
        df_1.to_csv(f'{lm_model}_exp_1_df_1_n.csv', index=False)

    else:
    
        df_1_cont = pd.read_csv(f'{path2}/anp_thesis_project/{lm_model}_exp_1_df_1.csv', delimiter=',')
        ...
        df_2.to_csv(f'{lm_model}_exp_1_df_2_n.csv', index=False)


        print(df_2_int)
    #else:
        df_2_cont = pd.read_csv(f'{path2}/anp_thesis_project/{lm_model}_exp_1_df_2.csv', delimiter=',')
        ...
        df_3.to_csv(f'{lm_model}_exp_1_df_3.csv', index=False)
        
    #else:
        df_3_cont = pd.read_csv(f'{path2}/anp_thesis_project/{lm_model}_exp_1_df_3.csv', delimiter=',')

        df_4 = post_processing_1(df_3_cont)


        df_4_c = df_4.copy()
        df_4_c.to_csv(f'{lm_model}_exp_1_df_4.csv', index=False)
